<p class="button">
<a href="<?php echo get_url('plugin/latexrender/documentation'); ?>">
<img src="<?php echo URL_PUBLIC; ?>wolf/plugins/latexrender/images/documentation.png" align="middle" /><?php echo __('Documentation'); ?>
</a>
</p>
<p class="button">
<a href="<?php echo get_url('plugin/latexrender/settings'); ?>">
<img src="<?php echo URL_PUBLIC; ?>wolf/plugins/latexrender/images/settings.png" align="middle" />
<?php echo __('Settings'); ?>
</a>
</p>
<div class="box">
<h2><?php echo __('Latex Render plugin');?></h2>
<p>
